        ...
        <div className="flex flex-col lg:flex-row items-end gap-6 relative w-full lg:w-2/3">
          ...
          <div className="flex flex-col items-start text-left w-full pb-8 z-30">
            ...
            <h1 className="text-4xl md:text-[52px] lg:text-[60px] font-black mb-4 font-heading leading-[1.15] tracking-tight w-full max-w-none">
              <span className="text-[#990000]">ติดต่อร้านแสงทอง ตลาดไท</span>{" "}
              <span className="text-[#3C2415] whitespace-nowrap">
                สั่งซื้อราคาส่ง 
              </span>
              <br />
              <span className="text-[#3C2415]">โทร/Line/facebook</span>{" "}
              {/* <span className="text-[#990000] whitespace-nowrap">
                มากกว่า 20 ปี
              </span> */}
            </h1>
            <p className="text-base md:text-lg font-bold text-[#4a3628] mb-8 leading-relaxed max-w-xl text-pretty">
              ...
              และวัตถุดิบเครื่องเทศ
              โดยมุ่งเน้นการคัดสรรสินค้าคุณภาพจากแหล่งผลิตโดยตรง
              เพื่อให้ลูกค้าได้รับสินค้าได้มาตรฐาน ในราคาส่งที่คุ้มค่า
            </p>
          </div>
        </div>
